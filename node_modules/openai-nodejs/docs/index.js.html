...
<head>
    <meta charset="utf-8">
    <title>OpenAI NodeJS: index.js</title>
...
<section>
    <article>
        <pre id="source" class="source-page line-numbers"><code class="language-js">const gpt3encoder = require('gpt-3-encoder');
...
module.exports = OpenAI;</code></pre>
    </article>
</section>
