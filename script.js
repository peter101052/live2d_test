...
camera.position.set(0.0, 1.45, 6.0);
...
const bgtexture = textureLoader.load('./assets/bg_photo.jpg');
...
function getTextContent() {
  let req_text = document.querySelector('textarea').value;
  openai_test(req_text);
}

function talktohead(txt) {
